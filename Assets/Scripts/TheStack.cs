...
public class TheStack : MonoBehaviour
{
    ...
    //ERROR MARGIN MAKES COMBO EASIER
    private const float ERROR_MARGIN = 0.23f;
            ...
            if (Mathf.Abs(deltaX) > ERROR_MARGIN)
            {
                ...
                CreateRubble
                    (
                        ...
                        , t.position.y
                        , t.position.z),
                        new Vector3(Mathf.Abs(deltaX), 2, t.localScale.z)
                    );
